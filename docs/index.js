...
Module['FS_createPath']("/", "books", true, true);
Module['FS_createPath']("/books", "more books", true, true);
Module['FS_createPath']("/books/more books", "more more books", true, true);
Module['FS_createPath']("/", "data", true, true);
Module['FS_createPath']("/data", "books", true, true);
Module['FS_createPath']("/data/books", "classic", true, true);
Module['FS_createPath']("/data/books", "scifi", true, true);
...
Module['FS_createPath']("/", "images", true, true);
    ...
    loadPackage({"files": [{"filename": "/books/ebookmarks.json", "start": 0, "end": 380}, {"filename": "/books/more books/more more books/test.md", "start": 380, "end": 622}, {"filename": "/books/more books/test.md", "start": 622, "end": 865}, {"filename": "/books/test.md", "start": 865, "end": 1069}, {"filename": "/books/test.md.bmk", "start": 1069, "end": 1070}, {"filename": "/data/Roboto-Regular.ttf", "start": 1070, "end": 516170}, {"filename": "/data/app_icons.bin", "start": 516170, "end": 523082}, {"filename": "/data/books/classic/moby_dick.txt", "start": 523082, "end": 523265}, {"filename": "/data/books/ebookmarks.json", "start": 523265, "end": 523645}, {"filename": "/data/books/scifi/nineteen_eighty_four.txt", "start": 523645, "end": 523830}, {"filename": "/data/books/test.md", "start": 523830, "end": 524034}, {"filename": "/data/books/test.md.bmk", "start": 524034, "end": 524035}, {"filename": "/data/books/test_document.rtf", "start": 524035, "end": 524297}, {"filename": "/data/images/fullhd.jpg", "start": 524297, "end": 754294}, {"filename": "/data/images/grayscale.jpg", "start": 754294, "end": 768592}, {"filename": "/data/images/landscape_1_1784804480098.jpg", "start": 768592, "end": 942573}, {"filename": "/data/images/landscape_2_1784804506450.jpg", "start": 942573, "end": 1193286}, {"filename": "/data/images/large.jpg", "start": 1193286, "end": 1253909}, {"filename": "/data/images/medium.jpg", "start": 1253909, "end": 1293266}, {"filename": "/data/images/portrait.jpg", "start": 1293266, "end": 1356915}, {"filename": "/data/images/screen_exact.jpg", "start": 1356915, "end": 1421047}, {"filename": "/data/images/small.jpg", "start": 1421047, "end": 1433611}, {"filename": "/data/images/tiny.jpg", "start": 1433611, "end": 1438322}, {"filename": "/data/images/xlarge.jpg", "start": 1438322, "end": 1534907}, {"filename": "/images/screen_exact.jpg", "start": 1534907, "end": 1575979}], "remote_package_size": 1575979});

  })();

// end include: /tmp/tmplwgw3wuk.js
// include: /tmp/tmp8_0fnmnn.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp8_0fnmnn.js
// include: /tmp/tmp61zvjf1z.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp61zvjf1z.js
...
var ASM_CONSTS = {
 ...
 176234: ($0, $1, $2, $3, $4) => { var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels / 4; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf; },  
 177222: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 177305: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 177374: () => { return window.innerWidth; },  
 177404: () => { return window.innerHeight; }
};
